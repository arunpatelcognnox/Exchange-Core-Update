 ...
 */
package com.arun.exchange.core2.core;
...
import com.arun.exchange.core2.core.common.api.ApiBinaryDataCommand;
import com.arun.exchange.core2.core.common.api.ApiCancelOrder;
import com.arun.exchange.core2.core.common.api.ApiCommand;
import com.arun.exchange.core2.core.common.api.ApiMoveOrder;
import com.arun.exchange.core2.core.common.api.ApiNop;
import com.arun.exchange.core2.core.common.api.ApiOrderBookRequest;
import com.arun.exchange.core2.core.common.api.ApiPersistState;
import com.arun.exchange.core2.core.common.api.ApiPlaceOrder;
import com.arun.exchange.core2.core.common.api.ApiReduceOrder;
import com.arun.exchange.core2.core.common.api.ApiReset;
import com.arun.exchange.core2.core.common.api.ApiResumeUser;
import com.arun.exchange.core2.core.common.api.ApiSuspendUser;
import com.arun.exchange.core2.core.common.api.binary.BinaryDataCommand;
import com.arun.exchange.core2.core.common.api.reports.ApiReportQuery;
...
import com.arun.exchange.core2.core.processors.BinaryCommandsProcessor;
...
//                || cmd.command == OrderCommandType.BINARY_DATA_QUERY) {
	...
	private void publishBinaryData(final OrderCommandType cmdType, final WriteBytesMarshallable data,
		...
		System.out.println(cmdType + " = " + data + " = " + dataTypeCode + " = " + transferId + " = " + endSeqConsumer);
		final double[] longsArrayData = SerializationUtils.bytesToDoubleArrayLz4(lz4Compressor,
...
//        log.debug("longsArrayData[{}] n={}", longsArrayData.length, totalNumMessagesToClaim);
		...
		do {
			...
			publishDoubleBinaryMessageFragment(cmdType, transferId, timestamp, endSeqConsumer, longsArrayData, fragmentSize,
	...
	private void publishDoubleBinaryMessageFragment(OrderCommandType cmdType, int transferId, long timestamp,
			LongConsumer endSeqConsumer, double[] longsArrayData, int fragmentSize, int offset, boolean isLastFragment) {
