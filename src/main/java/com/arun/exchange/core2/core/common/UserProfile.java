...
public class UserProfile implements WriteBytesMarshallable, StateHash {
    ...
    public IntObjectHashMap<SymbolPositionRecord> positions;
    ...
    // currency accounts
    // currency -> balance
    public IntDoubleHashMap accounts;
    ...
    public UserProfile(long uid, UserStatus userStatus) {
        ...
        this.accounts = new IntDoubleHashMap();
    ...
    public UserProfile(BytesIn bytesIn) {
        ...
        // account balances
        this.accounts = SerializationUtils.readIntDoubleHashMap(bytesIn);
