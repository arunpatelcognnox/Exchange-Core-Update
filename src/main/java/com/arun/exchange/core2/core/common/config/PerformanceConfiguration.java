...
import com.arun.exchange.core2.core.common.CoreWaitStrategy;
import com.arun.exchange.core2.core.orderbook.IOrderBook;
import com.arun.exchange.core2.core.orderbook.OrderBookNaiveImpl;
import com.arun.exchange.core2.core.utils.AffinityThreadFactory;
...
System.out.println("PerformanceConfiguration.PerformanceConfigurationBuilder 1");
        return builder()
...
//                .orderBookFactory(OrderBookDirectImpl::new);
    ...
    public static PerformanceConfiguration.PerformanceConfigurationBuilder throughputPerformanceBuilder() {
    	System.out.println("PerformanceConfiguration.PerformanceConfigurationBuilder 2");
        return builder()
