...
import com.arun.exchange.core2.core.orderbook.IOrderBook;
...
public final class MatchingEngineRouter implements WriteBytesMarshallable {
    ...
    public MatchingEngineRouter(final int shardId,
        ...
        RepostoryService.getCoreSymbolSpecificationRepository().findAll().forEach(x -> addSymbol(x));
    }

    public void processOrder(long seq, OrderCommand cmd) {

    	System.out.println("matcher => "+cmd);
