 ...
 */
package com.arun.exchange.core2.core.common.cmd;
...
public final class OrderCommand implements IOrder {
    ...
    public static OrderCommand newOrder(OrderType orderType, long orderId, long uid, double price, double reserveBidPrice, double size, OrderAction action) {
    ...
    public static OrderCommand reduce(long orderId, long uid, double reduceSize) {
        OrderCommand cmd = new OrderCommand();
    ...
    public static OrderCommand update(long orderId, long uid, double price) {
        OrderCommand cmd = new OrderCommand();
